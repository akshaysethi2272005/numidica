    ...
    <div>
      ...
      <div className={styless.navtype}>
        <div className={styless.select}>
          <input id="dkio1" type="text" placeholder="Enter Name" className={styless.inpse} /><br/>
          <input id="dkio2" type="date" className={styless.inpse} /><br/>
          <button className={stylesss.btns1} style={{marginLeft:"15px",marginTop:"10px"}} onClick={() => {
...

      {
        ik.map((data , i) => (
          <div id={data.id} key={i} className={styless.select2}>
                <p className={styless.his1}>{data.name}</p>
                <p className={styless.his1}>{data.dob}</p>
                <button id={data.id} className={stylesss.btns2} style={{marginLeft:"15px",marginTop:"10px"}} onClick={(k) => {
                ...
                <button className={stylesss.btns3} style={{marginLeft:"15px",marginTop:"10px"}} onClick={
                  (o) => {
